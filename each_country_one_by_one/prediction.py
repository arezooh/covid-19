...
def generate_data(h, numberOfCovariates, covariates_names, numberOfSelectedCounties, nameOfCountry):
    data = makeHistoricalData(h, r, test_size, 'death', 'mrmr', spatial_mode, target_mode, './',
                              future_features, pivot, nameOfCountry , end_date)
...
if __name__ == "__main__":
    ...
    validation_address = './' + end_date + '/results/country=' + str(country) + ' max_history=' + str(
        maxHistory) + '/validation/'
    test_address = './' + end_date + '/results/country=' + str(country) + ' max_history=' + str(
        maxHistory) + '/test/'
    env_address = './' + end_date + '/results/country=' + str(country) + ' max_history=' + str(
        maxHistory) + '/session_parameters/'
    mail_address = './' + end_date + '/results/country=' + str(country) + ' max_history=' + str(
        maxHistory) + '/email'
