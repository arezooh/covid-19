...
test_size = 21
# maxHistory = 2 * 7
maxHistory = 5 * 7 # min((14 * 7 - ((2*r)-7) - ((int(0) - 6) * 7)), 5 * 7)
...
def generate_data(h, numberOfCovariates, covariates_names, numberOfSelectedCounties):
    data = makeHistoricalData(h, r, test_size, 'death', 'mrmr', spatial_mode, target_mode, data_address, future_features, pivot, 0)
...
if __name__ == "__main__":
    ...
    validation_address = './' + str(argv[1]) + '/' + 'results/counties=' + str(numberOfSelectedCountiesname) + '/validation/'
    test_address = './' + str(argv[1]) + '/' + 'results/counties=' + str(numberOfSelectedCountiesname) + '/test/'
    env_address = './' + str(argv[1]) + '/' + 'results/counties=' + str(numberOfSelectedCountiesname) + '/session_parameters/'
    mail_address = './' + str(argv[1]) + '/' + 'results/counties=' + str(numberOfSelectedCountiesname) + '/email'
